...
public class EjemploNavegacionConstants {
    ...
    public static final String DROPDOWN_PRECIO_BAJO_XPATH = "xpath://*[@id=\"selectProductSort\"]/option[2]"; //dropdown para elegir el filtro en la busqueda (de mayor a menor, menos a mayor, alfabeticamente, etc)
